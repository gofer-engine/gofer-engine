...
const cb = jest.fn(async (msg: IMsg, ack: AckFunc | undefined, context?: IMessageContext) => true)
...
const msg = String.fromCharCode(0x0b) + `MSH|^~\\&|TEST|TEST|TEST|TEST|199912271408||ADT^A04^ADT_A04|1817457|D|2.5|` + String.fromCharCode(0x1c) + String.fromCharCode(0x0d)
