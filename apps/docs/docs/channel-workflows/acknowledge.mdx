...
<!-- TODO: Add link to Context Object -->

_More information on Msg More information on [Context Object](#)_
...
FIXME: Currently Delimitted Text message type acks respond with a [HL7v2 ACK](#hl7v2-acks) message.

## XML Acks

FIXME: Currently XML message type acks respond with a [HL7v2 ACK](#hl7v2-acks) message.
