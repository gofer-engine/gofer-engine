...
_**This tutorial is useful for building a standalone interface engine. If you are looking to integrate Gofer Engine into an existing application, you may find the [Integration Tutorial](./integration/index.md) more helpful.**_
